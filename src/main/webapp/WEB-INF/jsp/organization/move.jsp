...
<head>
    ...
    <link rel="stylesheet" href="${pageContext.request.contextPath}/resources/static/JQuery zTree v3.5.15/css/zTreeStyle/zTreeStyle.css">
    <style>
...
<body>
    ...
    <script src="${pageContext.request.contextPath}/resources/static/JQuery zTree v3.5.15/js/jquery.ztree.all-3.5.min.js"></script>
    <script>
        $(function () {
            var setting = {
                view: {
